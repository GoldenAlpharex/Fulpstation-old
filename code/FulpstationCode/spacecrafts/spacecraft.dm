...
/obj/vehicle/sealed/spacecraft
    ...
    icon = 'icons/mob/corgi_back.dmi' //We gotta have a placeholder for testing purposes, heh?
    ...
    var/haslights = TRUE //So we could potentially temper with the lights later on.
